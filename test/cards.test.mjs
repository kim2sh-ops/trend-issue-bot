...
test("buildCardSvgs: 커버 1 + 이슈 5 = 6장, 헤드라인 텍스트 포함", () => {
...
test("buildCardSvgs: 이슈 4개면 5장", () => {
  const d = { ...draft, issues: draft.issues.slice(0, 4) };
  assert.equal(buildCardSvgs(d).length, 5);
});

test("renderCards + renderReel: 실제 PNG/MP4 산출 (느림)", async () => {
