...
const BANNED =
  /유출|해킹|피싱|스캠|사망|숨진|숨져|숨졌|부고|빈소|자살|극단적 선택|구속|기소|송치|압수수색|선고|피의자|성범죄|성폭행|성추행|마약|음주운전|열애|결별|불륜|이혼|폭행|참사|국정감사|탄핵|대통령|장관|의원|갑질|의혹|논란|현장\s*조사|조사 착수|압박|담합|불공정|과징금|제재\s*(?:착수|검토)|고발|소송|피소|분쟁|리콜|결함|불량\s*(?:판정|논란)/;
...
- 다음은 무조건 제외 (광고 부적합): 정치인·정당·선거, 사건사고·범죄·재판·수사, 사망·부고·자살,
  ...
  기업 갑질·의혹·담합·불공정·과징금·고발·소송·현장조사, 제품 결함·리콜 논란.
  ※ 소비자에게 이득인 규제·단속(예: 플랫폼이 불량 판매자 제재)은 괜찮다.
